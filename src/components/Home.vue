...
import {discoverMovies, findMovie, findMovieById, hardcodedSizes} from "@/imports.mjs";
import AOS from 'aos';
...
onMounted( async()=>{
    ...
    try {
        const searchRequests = await discoverMovies();
        ...
        <div class="centerObject">
            <div class="container has-text-centered is-full mt-6">
                <div data-aos="fade-down">
                    <img class="img" src="../assets/WeMovie.PNG">
                    <h1 >Application de cinéma pour rechercher des films</h1>
                </div>
                <br>
                <h1 class="title is-12">Découvrer les nouveaux films</h1>
